...
class ConfigManager {
  ...
  constructor(env?: any) {
    ...
    this._config = {
      ...
      maxTokensLimit: parseInt(environment.MAX_TOKENS_LIMIT || '4096'),
      ...
      bigModel: environment.BIG_MODEL || 'gpt-oss-120b',
      middleModel: environment.MIDDLE_MODEL || environment.BIG_MODEL || 'gpt-oss-120b',
...
// For Cloudflare Workers environment, we'll create a config manager with the env object
